...
<head>
  ...
  <script src="../../ErrorsModals/updateSucess"></script>
...
{
  header('Location: ../UserViews/userDashboard.php');
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #f0ad4e;">
    ...
    <li class="nav-item">
        <a class="nav-link" href="../../../Backend/Controllers/UserControllers/login.php">Logout<span class="sr-only">(current)</span></a>
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" id="Yes" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-secondary" id="No" data-dismiss="modal" aria-hidden="true"></button>
        </div>
      </div>
    </div>
  </div>
