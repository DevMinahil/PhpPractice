...
// $playerOneCards = $deck->drawCards(7);
// print("Player one cards are as follows :");
// print_r($playerOneCards);

// $playerTwoCards  = $deck->drawCards(7);
// print("Player two cards are as follows :");
// print_r($playerTwoCards);

// $cards = $deck->returnCards();



// $deck->playerCards();
// print_r($deck->drawFour());
// print("After draw four the cards are :");
// $card = $deck->returnCards();
// print_r($card);
// print_r($deck->drawTwo());
// print("After draw twoclea the cards are :");
// $card = $deck->returnCards();
// print_r($card);

//print_r($deck->cardColor("Draw two Red"));
//print_r($deck->cardColor("DrawFourWild"));

// print_r($deck->cardColor("Skip Yellow"));
// // //Wild
 // print_r($deck->cardColor("Wild"));
// //
// //Reverse Yellow
// print_r($deck->cardColor("Reverse Yellow"));
// print_r($deck->cardColor("4 Green"));

// print_r($deck->cardColor("Draw two Green"));
